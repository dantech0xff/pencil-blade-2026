...
function buildDocumentation(report, residualLedger) {
  const lines = [
    ...
    `${residualLedger.summary.blockers} external rights/user-decision record remains disclosed.`,
    'It does not lower the technical contract score, assert a license exists, or block the',
    'owner-approved academic restoration closeout.',
    '',
