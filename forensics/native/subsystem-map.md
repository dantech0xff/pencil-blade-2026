...
| Toss/spawn | `TossTurn`, `WaveToss`, `ConcurrentToss`, `FreeToss`, `DoubleToss`, `BonusToss` | RNG formulas, timer semantics, strategies, all six production-mode factory tables, and spawn kinematics recovered | Exact engine/VFX RNG interleaving |
